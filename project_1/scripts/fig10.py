...
top_5_countries = x.sort_values(by='2023', ascending=False).head(5).sort_values(by='2023', ascending=True)
years = x.columns[2:-1]
...
ani.save('../images/fig10.gif', writer='imagemagick')
