...
random_year = '1985'
random_country_population_year = x[x['Country Name'] == random_country_name][random_year].values[0]
x.loc[:,'pop_diff_year'] = abs(x[random_year] - random_country_population_year)
...
def animate(year):
    ...
    for i, country in enumerate(closest_countries['Country Name']):
        ...
        text = ax.text(years[year], (population + population_density**2)*1.03, country_code, color='black', fontsize=15,
                       ha='center', va='bottom')
...
ani.save('../images/fig11.gif', writer='imagemagick')
