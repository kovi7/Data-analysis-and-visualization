...
random_year = '1985'
poland_value = countries[countries['Country Name'] == 'Poland'][random_year].values[0]
...
ani.save('../images/fig15.gif', writer='imagemagick')
